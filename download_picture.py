# -*- coding:utf-8 -*-
# @Time： 3/3/21 10:16 AM
# @Author: dyf-2316
# @FileName: download_picture.py
# @Software: PyCharm
# @Project: Intelligent_Photography_Guidance_System
# @Description: 用于爬取图片的工具模块
...
class Spider_baidu_image():
    def __init__(self):
        ...
        self.headers_image = {
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.\
            3497.81 Safari/537.36',
            'Referer': 'http://image.baidu.com/search/index?tn=baiduimage&ipn=r&ct=201326592&cl=2&lm=-1&st=-1&fm'
                       '=result&fr=&sf=1&fmq=1557124645631_R&pv=&ic=&nc=1&z=&hd=1&latest=0&copyright=0&se=1&showtab=0'
                       '&fb=0&width=&height=&face=0&istype=2&ie=utf-8&sid=&word=%E8%83%A1%E6%AD%8C'}
    ...
    def get_param(self):
        ...
        for i in range(1, self.paginator + 1):
            params.append(
                ...
                '}&s=&se=&tab=&width=&height=&face=0&istype=2&qc=&nc=1&fr=&expermode=&force=&cg=star&pn={'
                '}&rn=30&gsm=78&1557125391211='.format(
    ...
    def get_image(self, image_url):
        ...
        """
        cwd = os.getcwd()
        file_name = os.path.join(cwd + "/source/", self.keyword)
